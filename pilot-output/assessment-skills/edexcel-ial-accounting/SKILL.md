---
name: edexcel-ial-accounting
description: Scope and assessment model for Cambridge IGCSE Accounting (ACC (IAL)).
---

# edexcel-ial-accounting
...
- Assessment code: ACC (IAL)
- Source: Pearson Edexcel International A-Level Accounting specification (2025-2026)
- Valid: 2025 → 2026
...
2. `topics.json` — topic tree and classification hints (26 nodes).
...
- `skill_id`: `edexcel-ial-accounting`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-accounting-tNN`)
- `confidence`: 0.0–1.0
