---
name: dse-english-literature
description: Scope and assessment model for Cambridge IGCSE English Literature (DSE English Literature).
---

# dse-english-literature
...
- Assessment code: DSE English Literature
- Source: DSE English Literature Syllabus
- Valid: 2024 → (ongoing)
...
2. `topics.json` — topic tree and classification hints (10 nodes).
...
- `skill_id`: `dse-english-literature`
- `topic_id`: the most specific topic id (e.g. `dse-english-literature-tNN`)
- `confidence`: 0.0–1.0
