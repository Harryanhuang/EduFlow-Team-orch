---
name: edexcel-ial-mathematics
description: Scope and assessment model for Cambridge IGCSE Mathematics (YMA01 / YMA02).
---
...
Assessment skill for the Cambridge IGCSE Mathematics syllabus.
Use this skill to classify, route, or scope mathematics content
...
- Assessment code: YMA01 / YMA02
- Source: Pearson Edexcel International A-Level Mathematics specification (2025-2026)
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of mathematics items to CAIE IGCSE topics (default).
...
2. `topics.json` — topic tree and classification hints (11 nodes).
...
- `skill_id`: `edexcel-ial-mathematics`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-mathematics-tNN`)
- `confidence`: 0.0–1.0
