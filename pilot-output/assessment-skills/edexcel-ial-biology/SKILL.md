---
name: edexcel-ial-biology
description: Scope and assessment model for Cambridge IGCSE Biology (BIO (IAL)).
---
...
Assessment skill for the Cambridge IGCSE Biology syllabus.
Use this skill to classify, route, or scope biology content
...
- Assessment code: BIO (IAL)
- Source: Pearson Edexcel International A-Level Biology specification (2025-2026)
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of biology items to CAIE IGCSE topics (default).
...
- `skill_id`: `edexcel-ial-biology`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-biology-tNN`)
- `confidence`: 0.0–1.0
