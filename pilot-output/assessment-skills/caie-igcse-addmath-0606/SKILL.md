---
name: caie-igcse-addmath-0606
description: Scope and assessment model for Cambridge IGCSE Additional Mathematics (0606).
---

# caie-igcse-addmath-0606

## Overview

Assessment skill for the Cambridge IGCSE Additional Mathematics syllabus.
Use this skill to classify, route, or scope additional mathematics content
...
- Assessment code: 0606
- Source: Cambridge IGCSE Additional Mathematics 0606 syllabus (2028-2030)
- Valid: 2028 → 2030

## Supported use modes

- Classification / routing of additional mathematics items to CAIE IGCSE topics (default).
...
2. `topics.json` — topic tree and classification hints (15 nodes).
...
- `skill_id`: `caie-igcse-addmath-0606`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-addmath-0606-tNN`)
- `confidence`: 0.0–1.0
