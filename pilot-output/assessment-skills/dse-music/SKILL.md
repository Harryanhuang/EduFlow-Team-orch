---
name: dse-music
description: Scope and assessment model for Cambridge IGCSE Music (DSE Music).
---
...
Assessment skill for the Cambridge IGCSE Music syllabus.
Use this skill to classify, route, or scope music content
...
- Assessment code: DSE Music
- Source: DSE Music Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of music items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-music`
- `topic_id`: the most specific topic id (e.g. `dse-music-tNN`)
- `confidence`: 0.0–1.0
