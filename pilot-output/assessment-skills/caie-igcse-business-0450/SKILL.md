---
name: caie-igcse-business-0450
description: Scope and assessment model for Cambridge IGCSE Business Studies (0450).
---
...
Assessment skill for the Cambridge IGCSE Business Studies syllabus.
Use this skill to classify, route, or scope business studies content
...
- Assessment code: 0450
- Source: Cambridge IGCSE Business Studies 0450 syllabus (2026)
- Valid: 2026 → 2026

## Supported use modes

- Classification / routing of business studies items to CAIE IGCSE topics (default).
...
- `skill_id`: `caie-igcse-business-0450`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-business-0450-tNN`)
- `confidence`: 0.0–1.0
