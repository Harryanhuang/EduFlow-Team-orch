---
name: dse-chemistry
description: Scope and assessment model for Cambridge IGCSE Chemistry (DSE Chemistry).
---
...
- Assessment code: DSE Chemistry
- Source: DSE Chemistry Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-chemistry`
- `topic_id`: the most specific topic id (e.g. `dse-chemistry-tNN`)
- `confidence`: 0.0–1.0
