---
name: caie-igcse-chinese-firstlang-0509
description: Scope and assessment model for Cambridge IGCSE Chinese - First Language (0509).
---

# caie-igcse-chinese-firstlang-0509

## Overview

Assessment skill for the Cambridge IGCSE Chinese - First Language syllabus.
Use this skill to classify, route, or scope chinese - first language content
against the CAIE IGCSE syllabus.

- System: CAIE IGCSE
- Board/owner: Cambridge Assessment International Education
- Subject: Chinese - First Language
- Level: IGCSE (14-16 years)
- Assessment code: 0509
- Source: Cambridge IGCSE Chinese - First Language 0509 syllabus (2026-2027)
- Valid: 2026 → 2027

## Supported use modes

- Classification / routing of chinese - first language items to CAIE IGCSE topics (default).
...
2. `topics.json` — topic tree and classification hints (4 nodes).
...
- `skill_id`: `caie-igcse-chinese-firstlang-0509`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-chinese-firstlang-0509-tNN`)
- `confidence`: 0.0–1.0
