---
name: caie-alevel-physics-9702
description: Scope and assessment model for Cambridge IGCSE Physics (9702).
---
...
- Assessment code: 9702
- Source: Cambridge A-Level Physics 9702 syllabus (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `caie-alevel-physics-9702`
- `topic_id`: the most specific topic id (e.g. `caie-alevel-physics-9702-tNN`)
- `confidence`: 0.0–1.0
