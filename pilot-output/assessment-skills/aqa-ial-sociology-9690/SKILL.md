---
name: aqa-ial-sociology-9690
description: Scope and assessment model for Cambridge IGCSE Sociology (9690).
---

# aqa-ial-sociology-9690

## Overview

Assessment skill for the Cambridge IGCSE Sociology syllabus.
Use this skill to classify, route, or scope sociology content
...
- Assessment code: 9690
- Source: AQA International A-Level Sociology (9690) specification
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of sociology items to CAIE IGCSE topics (default).
...
- `skill_id`: `aqa-ial-sociology-9690`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-sociology-9690-tNN`)
- `confidence`: 0.0–1.0
