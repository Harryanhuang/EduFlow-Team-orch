---
name: edexcel-ial-computer-science
description: Scope and assessment model for Cambridge IGCSE Computer Science (XCS01 (IAL)).
---

# edexcel-ial-computer-science
...
- Assessment code: XCS01 (IAL)
- Source: Pearson Edexcel International A-Level Computer Science specification (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `edexcel-ial-computer-science`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-computer-science-tNN`)
- `confidence`: 0.0–1.0
