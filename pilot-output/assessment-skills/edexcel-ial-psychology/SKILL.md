---
name: edexcel-ial-psychology
description: Scope and assessment model for Cambridge IGCSE Psychology (PSY (IAL)).
---

# edexcel-ial-psychology

## Overview

Assessment skill for the Cambridge IGCSE Psychology syllabus.
Use this skill to classify, route, or scope psychology content
against the CAIE IGCSE syllabus.

- System: CAIE IGCSE
- Board/owner: Pearson Edexcel
- Subject: Psychology
- Level: International A-Level (IAL)
- Assessment code: PSY (IAL)
- Source: Pearson Edexcel International A-Level Psychology specification (2025-2026)
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of psychology items to CAIE IGCSE topics (default).
...
2. `topics.json` — topic tree and classification hints (31 nodes).
...
- `skill_id`: `edexcel-ial-psychology`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-psychology-tNN`)
- `confidence`: 0.0–1.0
