---
name: dse-technology-and-living
description: Scope and assessment model for Cambridge IGCSE Technology and Living (DSE Technology and Living).
---

# dse-technology-and-living

## Overview

Assessment skill for the Cambridge IGCSE Technology and Living syllabus.
Use this skill to classify, route, or scope technology and living content
...
- Assessment code: DSE Technology and Living
- Source: DSE Technology and Living Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of technology and living items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-technology-and-living`
- `topic_id`: the most specific topic id (e.g. `dse-technology-and-living-tNN`)
- `confidence`: 0.0–1.0
