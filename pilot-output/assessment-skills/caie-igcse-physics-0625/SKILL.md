---
name: caie-igcse-physics-0625
description: Scope and assessment model for Cambridge IGCSE Physics (0625).
---
...
- Assessment code: 0625
- Source: Cambridge IGCSE Physics 0625 syllabus (2023-2025)
- Valid: 2023 → 2025
...
- `skill_id`: `caie-igcse-physics-0625`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-physics-0625-tNN`)
- `confidence`: 0.0–1.0
