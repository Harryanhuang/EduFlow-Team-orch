...
description: AP Japanese Language and Culture course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Japanese Language and Culture course and exam, based on
...
- Assessment code: AP Japanese Language and Culture
- Source: AP Japanese Language and Culture Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Japanese Language and Culture units (default).
...
- `skill_id`: `ap-japanese-language-and-culture`
- `topic_id`: the most specific unit id (e.g. `ap-japanese-language-and-culture-unitNN`)
- `confidence`: 0.0–1.0
