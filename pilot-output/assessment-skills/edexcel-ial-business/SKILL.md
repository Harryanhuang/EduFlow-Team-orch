---
name: edexcel-ial-business
description: Scope and assessment model for Cambridge IGCSE Business (BUS (IAL)).
---

# edexcel-ial-business

## Overview

Assessment skill for the Cambridge IGCSE Business syllabus.
Use this skill to classify, route, or scope business content
...
- Assessment code: BUS (IAL)
- Source: Pearson Edexcel International A-Level Business specification (2025-2026)
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of business items to CAIE IGCSE topics (default).
...
2. `topics.json` — topic tree and classification hints (33 nodes).
...
- `skill_id`: `edexcel-ial-business`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-business-tNN`)
- `confidence`: 0.0–1.0
