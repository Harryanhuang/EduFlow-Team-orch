---
name: edexcel-ial-chemistry
description: Scope and assessment model for Cambridge IGCSE Chemistry (CHE (IAL)).
---
...
- Assessment code: CHE (IAL)
- Source: Pearson Edexcel International A-Level Chemistry specification (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `edexcel-ial-chemistry`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-chemistry-tNN`)
- `confidence`: 0.0–1.0
