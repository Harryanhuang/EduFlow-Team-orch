...
description: Scope and assessment model for Cambridge IGCSE Economics (0455).
---
...
- Assessment code: 0455
- Source: Cambridge IGCSE Economics 0455 syllabus (2023-2025)
- Valid: 2023 → 2025
...
- `skill_id`: `caie-igcse-economics-0455`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-economics-0455-tNN`)
- `confidence`: 0.0–1.0
