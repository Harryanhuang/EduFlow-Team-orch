---
name: aqa-ial-mathematics-7357
description: Scope and assessment model for Cambridge IGCSE Mathematics (IAL Maths 7357).
---

# aqa-ial-mathematics-7357
...
- System: CAIE IGCSE
- Board/owner: AQA (Oxford Cambridge and RSA Examinations)
- Subject: Mathematics
- Level: International A-Level (IAL)
- Assessment code: IAL Maths 7357
- Source: AQA International A-Level Mathematics (7357) specification (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-mathematics-7357`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-mathematics-7357-tNN`)
- `confidence`: 0.0–1.0
