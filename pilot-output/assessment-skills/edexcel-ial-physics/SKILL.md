...
description: Scope and assessment model for Cambridge IGCSE Physics (PHY (IAL)).
---
...
Assessment skill for the Cambridge IGCSE Physics syllabus.
Use this skill to classify, route, or scope physics content
...
- Assessment code: PHY (IAL)
- Source: Pearson Edexcel International A-Level Physics specification (2025-2026)
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of physics items to CAIE IGCSE topics (default).
...
2. `topics.json` — topic tree and classification hints (34 nodes).
...
- `skill_id`: `edexcel-ial-physics`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-physics-tNN`)
- `confidence`: 0.0–1.0
