---
name: aqa-ial-english-literature-7717
description: Scope and assessment model for Cambridge IGCSE English Literature (7717).
---

# aqa-ial-english-literature-7717

## Overview

Assessment skill for the Cambridge IGCSE English Literature syllabus.
Use this skill to classify, route, or scope english literature content
...
- Assessment code: 7717
- Source: AQA International A-Level English Literature (7717) specification
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of english literature items to CAIE IGCSE topics (default).
...
2. `topics.json` — topic tree and classification hints (5 nodes).
...
- `skill_id`: `aqa-ial-english-literature-7717`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-english-literature-7717-tNN`)
- `confidence`: 0.0–1.0
