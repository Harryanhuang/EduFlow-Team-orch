...
description: AP English Literature and Composition course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP English Literature and Composition course and exam, based on
...
- Assessment code: AP English Literature and Composition
- Source: AP English Literature and Composition Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP English Literature and Composition units (default).
...
- `skill_id`: `ap-english-literature-and-composition`
- `topic_id`: the most specific unit id (e.g. `ap-english-literature-and-composition-unitNN`)
- `confidence`: 0.0–1.0
