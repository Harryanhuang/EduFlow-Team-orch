...
description: AP German Language and Culture course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP German Language and Culture course and exam, based on
...
- Assessment code: AP German Language and Culture
- Source: AP German Language and Culture Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP German Language and Culture units (default).
...
- `skill_id`: `ap-german-language-and-culture`
- `topic_id`: the most specific unit id (e.g. `ap-german-language-and-culture-unitNN`)
- `confidence`: 0.0–1.0
