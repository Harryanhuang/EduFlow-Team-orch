---
name: dse-chinese-language
description: Scope and assessment model for Cambridge IGCSE Chinese Language (DSE Chinese Language).
---
...
Assessment skill for the Cambridge IGCSE Chinese Language syllabus.
Use this skill to classify, route, or scope chinese language content
...
- Assessment code: DSE Chinese Language
- Source: DSE Chinese Language Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of chinese language items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-chinese-language`
- `topic_id`: the most specific topic id (e.g. `dse-chinese-language-tNN`)
- `confidence`: 0.0–1.0
