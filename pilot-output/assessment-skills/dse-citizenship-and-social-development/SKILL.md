---
name: dse-citizenship-and-social-development
description: Scope and assessment model for Cambridge IGCSE Citizenship and Social Development (DSE Citizenship and Social Development).
---
...
Assessment skill for the Cambridge IGCSE Citizenship and Social Development syllabus.
Use this skill to classify, route, or scope citizenship and social development content
...
- Assessment code: DSE Citizenship and Social Development
- Source: DSE Citizenship and Social Development Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of citizenship and social development items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-citizenship-and-social-development`
- `topic_id`: the most specific topic id (e.g. `dse-citizenship-and-social-development-tNN`)
- `confidence`: 0.0–1.0
