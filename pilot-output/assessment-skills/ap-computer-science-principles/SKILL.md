...
description: AP Computer Science Principles course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Computer Science Principles course and exam, based on
...
- Assessment code: AP Computer Science Principles
- Source: AP Computer Science Principles Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Computer Science Principles units (default).
...
- `skill_id`: `ap-computer-science-principles`
- `topic_id`: the most specific unit id (e.g. `ap-computer-science-principles-unitNN`)
- `confidence`: 0.0–1.0
