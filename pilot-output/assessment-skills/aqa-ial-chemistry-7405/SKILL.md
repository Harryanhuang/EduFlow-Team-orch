---
name: aqa-ial-chemistry-7405
description: Scope and assessment model for Cambridge IGCSE Chemistry (7405).
---

# aqa-ial-chemistry-7405
...
- Assessment code: 7405
- Source: AQA International A-Level Chemistry (7405) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-chemistry-7405`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-chemistry-7405-tNN`)
- `confidence`: 0.0–1.0
