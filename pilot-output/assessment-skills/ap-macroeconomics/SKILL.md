...
description: AP Macroeconomics course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Macroeconomics course and exam, based on
the College Board Course and Exam Description (CED).

- System: AP (College Board)
- Subject: Macroeconomics
- Level: AP (high school / college intro)
- Assessment code: AP Macroeconomics
- Source: AP Macroeconomics Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Macroeconomics units (default).
...
- `skill_id`: `ap-macroeconomics`
- `topic_id`: the most specific unit id (e.g. `ap-macroeconomics-unitNN`)
- `confidence`: 0.0–1.0
