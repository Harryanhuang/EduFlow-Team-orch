---
name: aqa-ial-business-9625
description: Scope and assessment model for Cambridge IGCSE Business (9625).
---

# aqa-ial-business-9625
...
- Assessment code: 9625
- Source: AQA International A-Level Business (9625) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-business-9625`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-business-9625-tNN`)
- `confidence`: 0.0–1.0
