---
name: aqa-ial-computer-science-9645
description: Scope and assessment model for Cambridge IGCSE Computer Science (9645).
---

# aqa-ial-computer-science-9645
...
- Assessment code: 9645
- Source: AQA International A-Level Computer Science (9645) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-computer-science-9645`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-computer-science-9645-tNN`)
- `confidence`: 0.0–1.0
