---
name: edexcel-ial-economics
description: Scope and assessment model for Cambridge IGCSE Economics (ECO (IAL)).
---
...
Assessment skill for the Cambridge IGCSE Economics syllabus.
Use this skill to classify, route, or scope economics content
...
- Assessment code: ECO (IAL)
- Source: Pearson Edexcel International A-Level Economics specification (2025-2026)
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of economics items to CAIE IGCSE topics (default).
...
- `skill_id`: `edexcel-ial-economics`
- `topic_id`: the most specific topic id (e.g. `edexcel-ial-economics-tNN`)
- `confidence`: 0.0–1.0
