...
description: AP Italian Language and Culture course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Italian Language and Culture course and exam, based on
...
- Assessment code: AP Italian Language and Culture
- Source: AP Italian Language and Culture Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Italian Language and Culture units (default).
...
- `skill_id`: `ap-italian-language-and-culture`
- `topic_id`: the most specific unit id (e.g. `ap-italian-language-and-culture-unitNN`)
- `confidence`: 0.0–1.0
