---
name: caie-alevel-computer-science-9618
description: Scope and assessment model for Cambridge IGCSE Computer Science (9618).
---

# caie-alevel-computer-science-9618
...
- Assessment code: 9618
- Source: Cambridge A-Level Computer Science 9618 syllabus (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `caie-alevel-computer-science-9618`
- `topic_id`: the most specific topic id (e.g. `caie-alevel-computer-science-9618-tNN`)
- `confidence`: 0.0–1.0
