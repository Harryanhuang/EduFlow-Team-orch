---
name: ap-physics-1
description: AP Physics 1: Algebra-Based course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Physics 1: Algebra-Based course and exam, based on
...
- Assessment code: AP Physics 1: Algebra-Based
- Source: AP Physics 1: Algebra-Based Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Physics 1: Algebra-Based units (default).
...
- `skill_id`: `ap-physics-1`
- `topic_id`: the most specific unit id (e.g. `ap-physics-1-unitNN`)
- `confidence`: 0.0–1.0
