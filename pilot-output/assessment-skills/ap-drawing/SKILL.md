---
name: ap-drawing
description: AP Drawing course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Drawing course and exam, based on
the College Board Course and Exam Description (CED).

- System: AP (College Board)
- Subject: Drawing
- Level: AP (high school / college intro)
- Assessment code: AP Drawing
- Source: AP Drawing Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Drawing units (default).
...
- `skill_id`: `ap-drawing`
- `topic_id`: the most specific unit id (e.g. `ap-drawing-unitNN`)
- `confidence`: 0.0–1.0
