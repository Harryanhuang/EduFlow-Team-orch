---
name: aqa-ial-english-language-7702
description: Scope and assessment model for Cambridge IGCSE English Language (7702).
---

# aqa-ial-english-language-7702

## Overview

Assessment skill for the Cambridge IGCSE English Language syllabus.
Use this skill to classify, route, or scope english language content
...
- Assessment code: 7702
- Source: AQA International A-Level English Language (7702) specification
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of english language items to CAIE IGCSE topics (default).
...
- `skill_id`: `aqa-ial-english-language-7702`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-english-language-7702-tNN`)
- `confidence`: 0.0–1.0
