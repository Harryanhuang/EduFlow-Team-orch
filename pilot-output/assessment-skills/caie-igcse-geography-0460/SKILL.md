---
name: caie-igcse-geography-0460
description: Scope and assessment model for Cambridge IGCSE Geography (0460).
---
...
- Assessment code: 0460
- Source: Cambridge IGCSE Geography 0460 syllabus (2027-2029)
- Valid: 2027 → 2029
...
- `skill_id`: `caie-igcse-geography-0460`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-geography-0460-tNN`)
- `confidence`: 0.0–1.0
