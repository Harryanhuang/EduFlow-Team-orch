---
name: dse-integrated-science
description: Scope and assessment model for Cambridge IGCSE Integrated Science (DSE Integrated Science).
---

# dse-integrated-science

## Overview

Assessment skill for the Cambridge IGCSE Integrated Science syllabus.
Use this skill to classify, route, or scope integrated science content
...
- Assessment code: DSE Integrated Science
- Source: DSE Integrated Science Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of integrated science items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-integrated-science`
- `topic_id`: the most specific topic id (e.g. `dse-integrated-science-tNN`)
- `confidence`: 0.0–1.0
