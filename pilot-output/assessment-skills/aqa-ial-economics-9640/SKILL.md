---
name: aqa-ial-economics-9640
description: Scope and assessment model for Cambridge IGCSE Economics (9640).
---

# aqa-ial-economics-9640
...
- Assessment code: 9640
- Source: AQA International A-Level Economics (9640) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-economics-9640`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-economics-9640-tNN`)
- `confidence`: 0.0–1.0
