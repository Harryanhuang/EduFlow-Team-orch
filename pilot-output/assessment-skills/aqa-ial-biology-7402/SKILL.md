---
name: aqa-ial-biology-7402
description: Scope and assessment model for Cambridge IGCSE Biology (7402).
---
...
- Assessment code: 7402
- Source: AQA International A-Level Biology (7402) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-biology-7402`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-biology-7402-tNN`)
- `confidence`: 0.0–1.0
