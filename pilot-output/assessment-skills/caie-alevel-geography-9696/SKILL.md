---
name: caie-alevel-geography-9696
description: Scope and assessment model for Cambridge IGCSE Geography (9696).
---

# caie-alevel-geography-9696
...
- Assessment code: 9696
- Source: Cambridge A-Level Geography 9696 syllabus (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `caie-alevel-geography-9696`
- `topic_id`: the most specific topic id (e.g. `caie-alevel-geography-9696-tNN`)
- `confidence`: 0.0–1.0
