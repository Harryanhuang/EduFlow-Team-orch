---
name: dse-english-language
description: Scope and assessment model for Cambridge IGCSE English Language (DSE English Language).
---
...
- Assessment code: DSE English Language
- Source: DSE English Language Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-english-language`
- `topic_id`: the most specific topic id (e.g. `dse-english-language-tNN`)
- `confidence`: 0.0–1.0
