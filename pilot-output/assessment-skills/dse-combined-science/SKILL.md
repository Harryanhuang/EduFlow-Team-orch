---
name: dse-combined-science
description: Scope and assessment model for Cambridge IGCSE Combined Science (DSE Combined Science).
---

# dse-combined-science
...
- Assessment code: DSE Combined Science
- Source: DSE Combined Science Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-combined-science`
- `topic_id`: the most specific topic id (e.g. `dse-combined-science-tNN`)
- `confidence`: 0.0–1.0
