---
name: caie-alevel-history-9489
description: Scope and assessment model for Cambridge IGCSE History (9489).
---

# caie-alevel-history-9489
...
- Assessment code: 9489
- Source: Cambridge International AS & A Level History 9489 syllabus (2026)
- Valid: 2026 → 2026
...
- `skill_id`: `caie-alevel-history-9489`
- `topic_id`: the most specific topic id (e.g. `caie-alevel-history-9489-tNN`)
- `confidence`: 0.0–1.0
