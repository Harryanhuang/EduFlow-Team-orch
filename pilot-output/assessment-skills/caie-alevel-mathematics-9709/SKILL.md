---
name: caie-alevel-mathematics-9709
description: Scope and assessment model for Cambridge IGCSE Mathematics (9709).
---
...
- Assessment code: 9709
- Source: Cambridge A-Level Mathematics 9709 syllabus (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `caie-alevel-mathematics-9709`
- `topic_id`: the most specific topic id (e.g. `caie-alevel-mathematics-9709-tNN`)
- `confidence`: 0.0–1.0
