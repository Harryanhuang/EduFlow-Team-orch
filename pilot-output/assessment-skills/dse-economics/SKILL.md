---
name: dse-economics
description: Scope and assessment model for Cambridge IGCSE Economics (DSE Economics).
---
...
- Assessment code: DSE Economics
- Source: DSE Economics Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-economics`
- `topic_id`: the most specific topic id (e.g. `dse-economics-tNN`)
- `confidence`: 0.0–1.0
