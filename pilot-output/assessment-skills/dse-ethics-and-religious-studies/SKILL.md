---
name: dse-ethics-and-religious-studies
description: Scope and assessment model for Cambridge IGCSE Ethics and Religious Studies (DSE Ethics and Religious Studies).
---

# dse-ethics-and-religious-studies

## Overview

Assessment skill for the Cambridge IGCSE Ethics and Religious Studies syllabus.
Use this skill to classify, route, or scope ethics and religious studies content
...
- Assessment code: DSE Ethics and Religious Studies
- Source: DSE Ethics and Religious Studies Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of ethics and religious studies items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-ethics-and-religious-studies`
- `topic_id`: the most specific topic id (e.g. `dse-ethics-and-religious-studies-tNN`)
- `confidence`: 0.0–1.0
