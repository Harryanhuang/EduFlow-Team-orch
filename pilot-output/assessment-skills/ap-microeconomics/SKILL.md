...
description: AP Microeconomics course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Microeconomics course and exam, based on
the College Board Course and Exam Description (CED).

- System: AP (College Board)
- Subject: Microeconomics
- Level: AP (high school / college intro)
- Assessment code: AP Microeconomics
- Source: AP Microeconomics Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Microeconomics units (default).
...
- `skill_id`: `ap-microeconomics`
- `topic_id`: the most specific unit id (e.g. `ap-microeconomics-unitNN`)
- `confidence`: 0.0–1.0
