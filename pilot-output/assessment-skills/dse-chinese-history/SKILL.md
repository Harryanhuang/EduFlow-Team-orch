---
name: dse-chinese-history
description: Scope and assessment model for Cambridge IGCSE Chinese History (DSE Chinese History).
---
...
Assessment skill for the Cambridge IGCSE Chinese History syllabus.
Use this skill to classify, route, or scope chinese history content
...
- Assessment code: DSE Chinese History
- Source: DSE Chinese History Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of chinese history items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-chinese-history`
- `topic_id`: the most specific topic id (e.g. `dse-chinese-history-tNN`)
- `confidence`: 0.0–1.0
