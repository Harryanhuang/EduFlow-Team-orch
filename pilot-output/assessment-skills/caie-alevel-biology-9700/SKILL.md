---
name: caie-alevel-biology-9700
description: Scope and assessment model for Cambridge IGCSE Biology (9700).
---
...
- Assessment code: 9700
- Source: Cambridge A-Level Biology 9700 syllabus (2025-2026)
- Valid: 2025 → 2026
...
- `skill_id`: `caie-alevel-biology-9700`
- `topic_id`: the most specific topic id (e.g. `caie-alevel-biology-9700-tNN`)
- `confidence`: 0.0–1.0
