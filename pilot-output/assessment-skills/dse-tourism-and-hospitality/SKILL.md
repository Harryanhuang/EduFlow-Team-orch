---
name: dse-tourism-and-hospitality
description: Scope and assessment model for Cambridge IGCSE Tourism and Hospitality (DSE Tourism and Hospitality).
---

# dse-tourism-and-hospitality

## Overview

Assessment skill for the Cambridge IGCSE Tourism and Hospitality syllabus.
Use this skill to classify, route, or scope tourism and hospitality content
...
- Assessment code: DSE Tourism and Hospitality
- Source: DSE Tourism and Hospitality Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of tourism and hospitality items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-tourism-and-hospitality`
- `topic_id`: the most specific topic id (e.g. `dse-tourism-and-hospitality-tNN`)
- `confidence`: 0.0–1.0
