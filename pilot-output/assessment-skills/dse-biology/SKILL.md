---
name: dse-biology
description: Scope and assessment model for Cambridge IGCSE Biology (DSE Biology).
---
...
- Assessment code: DSE Biology
- Source: DSE Biology Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-biology`
- `topic_id`: the most specific topic id (e.g. `dse-biology-tNN`)
- `confidence`: 0.0–1.0
