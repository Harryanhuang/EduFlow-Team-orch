---
name: dse-physics
description: Scope and assessment model for Cambridge IGCSE Physics (DSE Physics).
---
...
- Assessment code: DSE Physics
- Source: DSE Physics Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-physics`
- `topic_id`: the most specific topic id (e.g. `dse-physics-tNN`)
- `confidence`: 0.0–1.0
