---
name: dse-chinese-literature
description: Scope and assessment model for Cambridge IGCSE Chinese Literature (DSE Chinese Literature).
---

# dse-chinese-literature

## Overview

Assessment skill for the Cambridge IGCSE Chinese Literature syllabus.
Use this skill to classify, route, or scope chinese literature content
...
- Assessment code: DSE Chinese Literature
- Source: DSE Chinese Literature Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of chinese literature items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-chinese-literature`
- `topic_id`: the most specific topic id (e.g. `dse-chinese-literature-tNN`)
- `confidence`: 0.0–1.0
