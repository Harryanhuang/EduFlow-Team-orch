---
name: aqa-ial-physics-7408
description: Scope and assessment model for Cambridge IGCSE Physics (7408).
---
...
- Assessment code: 7408
- Source: AQA International A-Level Physics (7408) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-physics-7408`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-physics-7408-tNN`)
- `confidence`: 0.0–1.0
