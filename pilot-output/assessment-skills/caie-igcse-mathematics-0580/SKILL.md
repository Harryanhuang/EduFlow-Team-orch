---
name: caie-igcse-mathematics-0580
description: Scope and assessment model for Cambridge IGCSE Mathematics (0580).
---
...
2. `topics.json` — topic tree and classification hints (12 nodes).
...
- `skill_id`: `caie-igcse-mathematics-0580`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-mathematics-0580-tNN`)
- `confidence`: 0.0–1.0
