---
name: aqa-ial-further-mathematics-9665
description: Scope and assessment model for Cambridge IGCSE Further Mathematics (9665).
---

# aqa-ial-further-mathematics-9665

## Overview

Assessment skill for the Cambridge IGCSE Further Mathematics syllabus.
Use this skill to classify, route, or scope further mathematics content
...
- Assessment code: 9665
- Source: AQA International A-Level Further Mathematics (9665) specification
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of further mathematics items to CAIE IGCSE topics (default).
...
- `skill_id`: `aqa-ial-further-mathematics-9665`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-further-mathematics-9665-tNN`)
- `confidence`: 0.0–1.0
