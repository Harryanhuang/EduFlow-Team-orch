---
name: dse-mathematics
description: Scope and assessment model for Cambridge IGCSE Mathematics (DSE Mathematics).
---
...
- Assessment code: DSE Mathematics
- Source: DSE Mathematics Syllabus (Compulsory + Module 1/2)
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-mathematics`
- `topic_id`: the most specific topic id (e.g. `dse-mathematics-tNN`)
- `confidence`: 0.0–1.0
