...
description: AP French Language and Culture course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP French Language and Culture course and exam, based on
...
- Assessment code: AP French Language and Culture
- Source: AP French Language and Culture Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP French Language and Culture units (default).
...
- `skill_id`: `ap-french-language-and-culture`
- `topic_id`: the most specific unit id (e.g. `ap-french-language-and-culture-unitNN`)
- `confidence`: 0.0–1.0
