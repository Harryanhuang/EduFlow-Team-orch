...
description: AP Computer Science A course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Computer Science A course and exam, based on
...
- Assessment code: AP Computer Science A
- Source: AP Computer Science A Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Computer Science A units (default).
...
- `skill_id`: `ap-computer-science-a`
- `topic_id`: the most specific unit id (e.g. `ap-computer-science-a-unitNN`)
- `confidence`: 0.0–1.0
