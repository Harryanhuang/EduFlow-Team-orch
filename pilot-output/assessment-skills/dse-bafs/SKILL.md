---
name: dse-bafs
description: Scope and assessment model for Cambridge IGCSE Business, Accounting and Financial Studies (DSE Business, Accounting and Financial Studies).
---
...
Assessment skill for the Cambridge IGCSE Business, Accounting and Financial Studies syllabus.
Use this skill to classify, route, or scope business, accounting and financial studies content
...
- Assessment code: DSE Business, Accounting and Financial Studies
- Source: DSE Business, Accounting and Financial Studies Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of business, accounting and financial studies items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-bafs`
- `topic_id`: the most specific topic id (e.g. `dse-bafs-tNN`)
- `confidence`: 0.0–1.0
