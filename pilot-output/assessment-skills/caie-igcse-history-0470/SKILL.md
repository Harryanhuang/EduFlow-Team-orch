---
name: caie-igcse-history-0470
description: Scope and assessment model for Cambridge IGCSE History (0470).
---
...
Assessment skill for the Cambridge IGCSE History syllabus.
Use this skill to classify, route, or scope history content
...
- Assessment code: 0470
- Source: Cambridge IGCSE History 0470 syllabus (2027-2028)
- Valid: 2027 → 2028

## Supported use modes

- Classification / routing of history items to CAIE IGCSE topics (default).
...
- `skill_id`: `caie-igcse-history-0470`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-history-0470-tNN`)
- `confidence`: 0.0–1.0
