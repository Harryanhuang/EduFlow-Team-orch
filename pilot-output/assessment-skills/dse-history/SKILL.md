---
name: dse-history
description: Scope and assessment model for Cambridge IGCSE History (DSE History).
---
...
- Assessment code: DSE History
- Source: DSE History Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-history`
- `topic_id`: the most specific topic id (e.g. `dse-history-tNN`)
- `confidence`: 0.0–1.0
