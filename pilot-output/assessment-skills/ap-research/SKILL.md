---
name: ap-research
description: AP Research course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Research course and exam, based on
the College Board Course and Exam Description (CED).

- System: AP (College Board)
- Subject: Research
- Level: AP (high school / college intro)
- Assessment code: AP Research
- Source: AP Research Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Research units (default).
...
- `skill_id`: `ap-research`
- `topic_id`: the most specific unit id (e.g. `ap-research-unitNN`)
- `confidence`: 0.0–1.0
