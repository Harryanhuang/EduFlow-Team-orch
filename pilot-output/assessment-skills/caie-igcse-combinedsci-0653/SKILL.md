---
name: caie-igcse-combinedsci-0653
description: Scope and assessment model for Cambridge IGCSE Combined Science (0653).
---

# caie-igcse-combinedsci-0653

## Overview

Assessment skill for the Cambridge IGCSE Combined Science syllabus.
Use this skill to classify, route, or scope combined science content
...
- Assessment code: 0653
- Source: Cambridge IGCSE Combined Science 0653 syllabus (2028-2029)
- Valid: 2028 → 2029

## Supported use modes

- Classification / routing of combined science items to CAIE IGCSE topics (default).
...
- `skill_id`: `caie-igcse-combinedsci-0653`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-combinedsci-0653-tNN`)
- `confidence`: 0.0–1.0
