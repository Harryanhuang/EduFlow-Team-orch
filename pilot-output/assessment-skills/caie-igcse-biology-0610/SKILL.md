---
name: caie-igcse-biology-0610
description: Scope and assessment model for Cambridge IGCSE Biology (0610).
---
...
- Assessment code: 0610
- Source: Cambridge IGCSE Biology 0610 syllabus (2023-2025)
- Valid: 2023 → 2025
...
2. `topics.json` — topic tree and classification hints (24 nodes).
...
- `skill_id`: `caie-igcse-biology-0610`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-biology-0610-tNN`)
- `confidence`: 0.0–1.0
