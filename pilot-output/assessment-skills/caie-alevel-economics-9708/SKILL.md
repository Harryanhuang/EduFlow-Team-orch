---
name: caie-alevel-economics-9708
description: Scope and assessment model for Cambridge IGCSE Economics (9708).
---

# caie-alevel-economics-9708
...
- Assessment code: 9708
- Source: Cambridge A-Level Economics 9708 syllabus (2025-2026)
- Valid: 2025 → 2026
...
2. `topics.json` — topic tree and classification hints (6 nodes).
...
- `skill_id`: `caie-alevel-economics-9708`
- `topic_id`: the most specific topic id (e.g. `caie-alevel-economics-9708-tNN`)
- `confidence`: 0.0–1.0
