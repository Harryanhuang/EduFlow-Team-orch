---
name: dse-design-and-applied-technology
description: Scope and assessment model for Cambridge IGCSE Design and Applied Technology (DSE Design and Applied Technology).
---
...
Assessment skill for the Cambridge IGCSE Design and Applied Technology syllabus.
Use this skill to classify, route, or scope design and applied technology content
...
- Assessment code: DSE Design and Applied Technology
- Source: DSE Design and Applied Technology Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of design and applied technology items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-design-and-applied-technology`
- `topic_id`: the most specific topic id (e.g. `dse-design-and-applied-technology-tNN`)
- `confidence`: 0.0–1.0
