---
name: aqa-ial-chinese-9676
description: Scope and assessment model for Cambridge IGCSE Chinese (9676).
---

# aqa-ial-chinese-9676

## Overview

Assessment skill for the Cambridge IGCSE Chinese syllabus.
Use this skill to classify, route, or scope chinese content
...
- Assessment code: 9676
- Source: AQA International A-Level Chinese (9676) specification
- Valid: 2025 → 2026

## Supported use modes

- Classification / routing of chinese items to CAIE IGCSE topics (default).
...
- `skill_id`: `aqa-ial-chinese-9676`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-chinese-9676-tNN`)
- `confidence`: 0.0–1.0
