---
name: caie-igcse-psychology-0266
description: Scope and assessment model for Cambridge IGCSE Psychology (0266).
---

# caie-igcse-psychology-0266
...
- Assessment code: 0266
- Source: Cambridge IGCSE Psychology 0266 syllabus (2027-2029)
- Valid: 2027 → 2029
...
2. `topics.json` — topic tree and classification hints (7 nodes).
...
- `skill_id`: `caie-igcse-psychology-0266`
- `topic_id`: the most specific topic id (e.g. `caie-igcse-psychology-0266-tNN`)
- `confidence`: 0.0–1.0
