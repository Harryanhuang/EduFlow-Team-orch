---
name: aqa-ial-psychology-9685
description: Scope and assessment model for Cambridge IGCSE Psychology (9685).
---

# aqa-ial-psychology-9685
...
- Assessment code: 9685
- Source: AQA International A-Level Psychology (9685) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-psychology-9685`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-psychology-9685-tNN`)
- `confidence`: 0.0–1.0
