...
description: AP Cybersecurity course framework + exam structure (College Board CED).
---
...
Assessment skill for the AP Cybersecurity course and exam, based on
the College Board Course and Exam Description (CED).

- System: AP (College Board)
- Subject: Cybersecurity
- Level: AP (high school / college intro)
- Assessment code: AP Cybersecurity
- Source: AP Cybersecurity Course and Exam Description
- Valid: 2025 → (ongoing)
...
- Classification / routing of content to AP Cybersecurity units (default).
...
- `skill_id`: `ap-cybersecurity`
- `topic_id`: the most specific unit id (e.g. `ap-cybersecurity-unitNN`)
- `confidence`: 0.0–1.0
