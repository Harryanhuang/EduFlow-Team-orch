---
name: dse-geography
description: Scope and assessment model for Cambridge IGCSE Geography (DSE Geography).
---
...
- Assessment code: DSE Geography
- Source: DSE Geography Syllabus
- Valid: 2024 → (ongoing)
...
- `skill_id`: `dse-geography`
- `topic_id`: the most specific topic id (e.g. `dse-geography-tNN`)
- `confidence`: 0.0–1.0
