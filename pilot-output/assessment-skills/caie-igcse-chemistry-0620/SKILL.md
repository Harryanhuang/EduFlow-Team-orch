---
name: caie-igcse-chemistry-0620
description: Scope and assessment model for Cambridge IGCSE Chemistry (0620).
---
...
- `topic_id`: the most specific topic id (e.g. `caie-igcse-chemistry-0620-tNN`)
- `confidence`: 0.0–1.0
