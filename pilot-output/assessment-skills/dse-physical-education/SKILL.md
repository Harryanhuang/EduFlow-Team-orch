---
name: dse-physical-education
description: Scope and assessment model for Cambridge IGCSE Physical Education (DSE Physical Education).
---

# dse-physical-education

## Overview

Assessment skill for the Cambridge IGCSE Physical Education syllabus.
Use this skill to classify, route, or scope physical education content
...
- Assessment code: DSE Physical Education
- Source: DSE Physical Education Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of physical education items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-physical-education`
- `topic_id`: the most specific topic id (e.g. `dse-physical-education-tNN`)
- `confidence`: 0.0–1.0
