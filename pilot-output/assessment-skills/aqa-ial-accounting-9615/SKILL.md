---
name: aqa-ial-accounting-9615
description: Scope and assessment model for Cambridge IGCSE Accounting (9615).
---

# aqa-ial-accounting-9615
...
- Assessment code: 9615
- Source: AQA International A-Level Accounting (9615) specification
- Valid: 2025 → 2026
...
- `skill_id`: `aqa-ial-accounting-9615`
- `topic_id`: the most specific topic id (e.g. `aqa-ial-accounting-9615-tNN`)
- `confidence`: 0.0–1.0
