---
name: dse-information-and-communication-technology
description: Scope and assessment model for Cambridge IGCSE Information and Communication Technology (DSE Information and Communication Technology).
---
...
Assessment skill for the Cambridge IGCSE Information and Communication Technology syllabus.
Use this skill to classify, route, or scope information and communication technology content
...
- Assessment code: DSE Information and Communication Technology
- Source: DSE Information and Communication Technology Syllabus
- Valid: 2024 → (ongoing)

## Supported use modes

- Classification / routing of information and communication technology items to CAIE IGCSE topics (default).
...
- `skill_id`: `dse-information-and-communication-technology`
- `topic_id`: the most specific topic id (e.g. `dse-information-and-communication-technology-tNN`)
- `confidence`: 0.0–1.0
