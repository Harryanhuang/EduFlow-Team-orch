...
class ClaudeCodeAdapter(CliAdapter):
    def spawn_cmd(self, agent: str, model: str) -> str:
        # Full silent-launch recipe — bypass-permissions mode, theme picker, etc.
        # - IS_SANDBOX=1 + --dangerously-skip-permissions is the stable
        #   non-interactive path for Claude Code 2.1.181 on the EduFlow host.
        #   The newer --permission-mode bypassPermissions still opens a
        #   confirmation TUI here and can exit back to zsh after timeout.
