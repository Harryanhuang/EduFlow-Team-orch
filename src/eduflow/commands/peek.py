"""`eduflow peek <agent> [N]` — capture the last N lines of an agent's pane.
...
grep / less / `eduflow remember <agent> note "$(eduflow peek X)"`.
"""
...
USAGE = "usage: eduflow peek <agent> [N]   (default N=30, max 2000)"
